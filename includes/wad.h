...
void			parse_wad_level(t_binary_read *wad_bin, t_wad *wad,
						t_wad_directory *directory);

void			parse_wad_dssound(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_playpal(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_colormap(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_endoom(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_flat(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_patch(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);
void			parse_wad_sprite(t_binary_read *wad_bin,
						t_wad_general *wad_general, t_wad_directory *directory);

void			parse_wad_things(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_linedefs(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_sidedefs(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_vertexes(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_segs(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_ssectors(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_nodes(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_sectors(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_reject(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
void			parse_wad_blockmap(t_binary_read *wad_bin,
						t_wad_level *wad_level, t_wad_directory *directory);
