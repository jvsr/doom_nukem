...
/*   Updated: 2019/09/09 17:13:12 by ehollidg      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
			...
			else if (event.type == SDL_KEYDOWN)
			{
				...
				else if (event.key.keysym.sym == SDLK_1)
				{
					...
					time(
						...
						// time(sdl_surface_draw_rect_alpha(s, (SDL_Color){180, 34, 23, 180}, (SDL_Rect){50, 60, 650, 600}), "surDrawRect1");
						time(
						...
						time(sdl_surface_draw_circ(s, (SDL_Color){0, 0, 0, 0xff}, (t_circle){100000, (SDL_Point){INIT_WIDTH, INIT_HEIGHT}}), "surDrawCirc1");
						// time(sdl_draw_surface_rect_alpha(s, (SDL_Color){180, 34, 23, 180}, (SDL_Rect){50, 60, 650, 600}), "surDrawRect6");
					, "total");
				}
			}
		}
